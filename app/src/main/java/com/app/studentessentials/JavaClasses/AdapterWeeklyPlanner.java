...
public class AdapterWeeklyPlanner  extends BaseAdapter
{
    ...
    public AdapterWeeklyPlanner( Activity activity, ArrayList<ModelDailyPlanner> als) {
        this.als = als;
...
//                mFragment.setArguments(bundle);
        ...
        txt_time.setText(als.get(i).event_day);
