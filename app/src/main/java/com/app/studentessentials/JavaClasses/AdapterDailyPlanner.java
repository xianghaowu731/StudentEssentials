...
public class AdapterDailyPlanner extends BaseAdapter {
    private Activity activity;

    ArrayList<ModelDailyPlanner> als;
    FragmentManager fragmentManager;
    private AdapterDailyPlanner adapter;
    int j = 0;
    ...
    public AdapterDailyPlanner(FragmentManager fragmentManager, Activity activity, ArrayList<ModelDailyPlanner> als) {
        this.als = als;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup)
    {
        ...
        txt_time.setText(als.get(i).time);
