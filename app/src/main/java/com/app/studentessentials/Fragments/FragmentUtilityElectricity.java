 ...
 */
public class FragmentUtilityElectricity extends Fragment {
    ...
    public FragmentUtilityElectricity() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_fragment_utility_electricity, container, false);
            ...
            public void onClick(View view) {
                if(edt_meter_reading.getText().toString().equals("") ){
                    ...
                    if(previous_month_flag) {
                        if (Integer.parseInt(edt_meter_reading.getText().toString()) < Integer.parseInt(sharedPreferences.getString("previous_electricity_meter_reading", "0"))) {
                            Toast.makeText(getActivity(), "Please enter MAX reading then previous..!", Toast.LENGTH_SHORT).show();
                        } else {
                            //edt_kwh_used.setText(Integer.toString(Integer.parseInt(edt_meter_reading.getText().toString()) - Integer.parseInt(sharedPreferences.getString("previous_electricity_meter_reading", ""))));
                    ...
                    if(spin_reminder.getSelectedItemPosition() != 0){
                        ...
                        try{
                            ...
                            String noti_id = String.format("electricity-%s", month);
                            ...
                            String noti_content = month + " Electicity Meter Reading";
       ...
       // var_root = "April 2018";
        ...
        String pre_reminder = sharedPreferences.getString("electricity_reminder", "0");
    ...
    public void initializeView(){
        ...
        //sw_reminder = (Switch) view.findViewById(R.id.swtch_reminder);
        ...
        spin_reminder.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                if(i == 1){
                    editor.putString("electricity_reminder" , "1");
                    editor.commit();
                } else if(i ==2){
                    editor.putString("electricity_reminder" , "2");
                    editor.commit();
                }
    ...
    public void insertElectricReadingOnFirebase(){
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>(){
            ...
            public void onResponse(String s) {
                ...
                reference.child(var_root).child("electricity_meter_reading").setValue(edt_meter_reading.getText().toString());
                if(previous_month_flag){
                    ...
                    reference.child(var_root).child("electricity_monthly_uses").setValue(edt_kwh_used.getText().toString());
                }
    ...
    public void doOnSuccess(String s){
        ...
        try {
            ...
            while(i.hasNext()){
                ...
                String used_str = "";
                if(emp.has("electricity_meter_reading")){
                    meter_reading=emp.getString("electricity_meter_reading");
                    used_str = emp.getString("electricity_monthly_uses");

                    if (previousMonth.equals(emp.getString("month"))){
                        editor.putString("previous_electricity_meter_reading" , meter_reading);
                        editor.commit();
                        previous_month_flag = true;
                        previous_reading = meter_reading;
                    }
                    if(month.equals(emp.getString("month"))){
                        editor.putString("current_electricity_meter_reading" , meter_reading);
                        editor.putString("previous_electricity_meter_reading" , used_str);
                        editor.commit();
                        month_flag = true;
                    } else{
                    ...
                    //entries.add(new BarEntry(Integer.parseInt(meter_reading) - Integer.parseInt(used_str), flag));
                    ...
                    barcolors.add(ContextCompat.getColor(getContext(), R.color.yello));
                }
            }
            if(flag > 0){
            ...
            edt_meter_reading.setText(sharedPreferences.getString("current_electricity_meter_reading", ""));
            edt_kwh_used.setText(sharedPreferences.getString("previous_electricity_meter_reading", ""));
