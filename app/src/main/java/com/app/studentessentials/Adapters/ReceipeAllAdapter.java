...
public class ReceipeAllAdapter extends RecyclerView.Adapter<ReceipeAllAdapter.ViewHolder> implements Filterable {
     ...
     */
    public ReceipeAllAdapter(List<RecipeModel> dataSet, Context context) {
        dataset = dataSet;
        mContext = context;
