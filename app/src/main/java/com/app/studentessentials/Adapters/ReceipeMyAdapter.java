...
public class ReceipeMyAdapter extends RecyclerView.Adapter<ReceipeMyAdapter.ViewHolder> implements Filterable {
     ...
     */
    public ReceipeMyAdapter(List<RecipeModel> dataSet, Context context) {
        dataset = dataSet;
        mContext = context;
